...
namespace rocket_bot
{
    public partial class My_Bot
    {
        ...
        public My_Bot(Level level, Channel<Rocket> channel, int movesCount, int iterationsCount, Random random,
            int threadsCount)
        {
            this.level = level;
        ...
        public Tuple<Turn, double> SearchBestMove(Rocket rocket, Random searchRandom, int searchIterationsCount)
        {
